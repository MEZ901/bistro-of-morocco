            ...
            <div class="bg-white relative shadow-md sm:rounded-lg overflow-hidden">
                <div class="flex flex-col md:flex-row items-center justify-between space-y-3 md:space-y-0 md:space-x-4 p-4">
                    ...
                    <div class="w-full md:w-auto flex flex-col md:flex-row space-y-2 md:space-y-0 items-stretch md:items-center justify-end md:space-x-3 flex-shrink-0">
                        <button type="button" id="createModalButton" data-modal-toggle="createModal" class="flex items-center justify-center text-white bg-primary-700 hover:bg-primary-800 focus:ring-4 focus:ring-primary-300 font-medium rounded-lg text-sm px-4 py-2">
                            ...
                            <div id="filterDropdown" class="z-10 hidden w-48 p-3 bg-white rounded-lg shadow">
                                ...
                                <ul class="space-y-2 text-sm" aria-labelledby="filterDropdownButton">
                                    <li class="flex items-center">
                                        ...
                                        <label for="apple" class="ml-2 text-sm font-medium text-gray-900">Breakfast (56)</label>
                                    </li>
                                    <li class="flex items-center">
                                        ...
                                        <label for="fitbit" class="ml-2 text-sm font-medium text-gray-900">Lunch (16)</label>
                                    </li>
                                    <li class="flex items-center">
                                        ...
                                        <label for="razor" class="ml-2 text-sm font-medium text-gray-900">Dinner (49)</label>
                                    </li>
                                </ul>
                            </div>
                        </div>
                ...
                <div class="overflow-x-auto">
                    <table class="w-full text-sm text-left text-gray-500">
                        <thead class="text-xs text-gray-700 uppercase bg-gray-50">
                            <tr>
                                <th scope="col" class="px-4 py-3">Meal name</th>
